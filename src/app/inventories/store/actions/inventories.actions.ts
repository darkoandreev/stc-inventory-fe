...
export const createItem = createAction('[Inventories Page] Create new inventory', props<{ inventory: IInventory} >());
export const createItemSuccess = createAction('[Inventories Page] Create new inventory Success', props<{ inventory: IInventory }>());
export const createItemsError = createAction('[Inventories Page] Create new inventory Error', (error: Error) => error);

export const getCategories = createAction('[Inventories Page] Get Category');
export const getCategoriesSuccess = createAction('[Inventories Page] Get Category Success', props<{ categories: ICategory[] }>());
export const getCategoriesError = createAction('[Inventories Page] Get Category Error', (error: Error) => error);
...
export const editInventoryError = createAction('[Inventories Page] Edit Inventory Error', (error: Error) => error);
...
export const getInventoryError = createAction('[Inventories Page] Get Inventory Error', (error: Error) => error);
...
export const getInventoriesError = createAction('[Inventories Page] Get Inventories Error', (error: Error) => error);
...
export const searchInventoriesError = createAction('[Inventories Page] Get Inventories Error', (error: Error) => error);
...
export const deleteInventoryError = createAction('[Inventories Page] Delete Inventory Error', (error: Error) => error);